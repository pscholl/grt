...
bool MovementDetector::saveModelToFile( std::ostream &file ) const{
    ...
    if( !MLBase::saveBaseSettingsToFile(file) ){
        errorLog <<"saveModelToFile(ostream &file) - Failed to save ML base settings to file!" << std::endl;
        return false;
    }
...
bool MovementDetector::loadModelFromFile( std::istream &file ){
    ...
    if( word != "SearchTimeout:" ){
        errorLog <<"loadModelFromFile(istream &file) - Failed to read SearchTimeout header!" << std::endl;
        return false;
    }
    file >> searchTimeout;
    ...
    if( word != "UpperThreshold:" ){
        errorLog <<"loadModelFromFile(istream &file) - Failed to read UpperThreshold header!" << std::endl;
        return false;
    }
    file >> upperThreshold;
    ...
    if( word != "LowerThreshold:" ){
        errorLog <<"loadModelFromFile(istream &file) - Failed to read LowerThreshold header!" << std::endl;
        return false;
    }
    file >> lowerThreshold;
    ...
    file >> word;
    if( word != "Gamma:" ){
        errorLog <<"loadModelFromFile(istream &file) - Failed to read Gamma header!" << std::endl;
        return false;
    }
    file >> gamma;
